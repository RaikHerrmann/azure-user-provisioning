...
.DESCRIPTION
    Reads a user list (same format as the main provisioning scripts) and assigns
    a Microsoft Copilot Studio license to each user via the Microsoft Graph API.

    This script is independent from the Azure sandbox provisioning scripts and
...
.EXAMPLE
    ...
    pwsh ./Assign-CopilotStudioLicense.ps1 -InputFile "../input/users.csv" -SkuPartNumber "COPILOT_STUDIO"
#>
