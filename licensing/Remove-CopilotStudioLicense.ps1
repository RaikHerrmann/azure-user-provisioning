...
.DESCRIPTION
    Reads a user list (same format as the main provisioning scripts) and removes
    the Microsoft Copilot Studio license from each user via the Microsoft Graph API.

    This script is independent from the Azure sandbox provisioning scripts.
...
.EXAMPLE
    ...
    pwsh ./Remove-CopilotStudioLicense.ps1 -InputFile "../input/users.csv" -SingleUser "john.doe@contoso.com"
#>
